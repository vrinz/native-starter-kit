...
class BookingHistories2 extends Component {
    ...
    render() {
        return (
            <Container theme={myTheme} style={{backgroundColor: '#fff'}}>
                ...
                <Content>
                   <Image style={styles.imgstl1} source={require('../../../images/bh-2.png')}></Image>
                   <Text> </Text>
...
export default connect(null, bindAction)(BookingHistories2);
