...
class BookingHistories1 extends Component {
    ...
    render() {
        return (
            <Container theme={myTheme} style={{backgroundColor: '#fff'}}>
                ...
                <Content>
                   <Image style={styles.imgstl1} source={require('../../../images/bh-1.png')}></Image>
                   <Text> </Text>
...
export default connect(null, bindAction)(BookingHistories1);
