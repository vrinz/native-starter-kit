...
class AvailableBooking2 extends Component {
    ...
    render() {
        return (
            <Container theme={myTheme} style={{backgroundColor: '#fff'}}>
                ...
                <Content>
                <ListItem style={styles.liitem1} onPress={() => this.navigateTo('availableBooking2')} >
                      <Image style={styles.imgstl1} source={require('../../../images/av-2a.png')}></Image>
                </ListItem>
                   <Text> </Text>
                   <Text> </Text>
...
export default connect(null, bindAction)(AvailableBooking2);
