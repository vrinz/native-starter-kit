...
class BookingList3 extends Component {
    ...
    render() {
        return (
            <Container theme={myTheme} style={{backgroundColor: '#fff'}}>
                ...
                <Content>
                   <Image style={styles.imgstl1} source={require('../../../images/bl-3.png')}></Image>
                   <Text> </Text>
...
export default connect(null, bindAction)(BookingList3);
